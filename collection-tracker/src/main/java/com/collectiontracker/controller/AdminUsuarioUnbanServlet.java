...
@WebServlet("/api/admin/usuarios/unban")
public class AdminUsuarioUnbanServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.unbanUser(userId);
            
            Map<String, Object> res = new HashMap<>();
            res.put("ok", result);
            res.put("mensaje", result ? "Usuario desbaneado" : "Error al desbanear");
            response.getWriter().write(gson.toJson(res));
